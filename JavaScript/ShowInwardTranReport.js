var config = {
    DownloadInwardTranRecord: document.getElementById('DownloadInwardTranRecord').getAttribute('data-url'),
    ShowInwardTranReport: document.getElementById('ShowInwardTranReport').getAttribute('data-url'),
};

document.getElementById("downloadForm").addEventListener("submit", function () {
    var startDate = document.getElementById("startDate").value;
    var endDate = document.getElementById("endDate").value;
    var action = config.DownloadInwardTranRecord + '?StartDate=' + encodeURIComponent(startDate) + '&EndDate=' + encodeURIComponent(endDate);
    this.action = action;
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function getAmortizationSummary() {
        ...
        /*token = $(token).val();*/
        $.ajax({
            url: config.ShowInwardTranReport,
