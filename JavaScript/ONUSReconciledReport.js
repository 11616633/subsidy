var config = {
    ONUSDownloadReconciledReport: document.getElementById('ONUSDownloadReconciledReport').getAttribute('data-url'),
    ONUSReconcileData: document.getElementById('ONUSReconcileData').getAttribute('data-url'),
    ONUSReconciledReport: document.getElementById('ONUSReconciledReport').getAttribute('data-url')
};
...
document.getElementById("downloadForm").addEventListener("submit", function (event) {
    ...
    var endDate = document.getElementById("endDate").value;
    var action = config.ONUSDownloadReconciledReport + '?EndDate=' + encodeURIComponent(endDate);
...
$(document).ready(function () {
    $('#btnReconc').click(function () {
        ...
        $.ajax({
            url: '/OnUs/ONUSReconcileData', // Update with your actual controller route
            type: 'POST',
            contentType: 'application/json',
            ...
            success: function (response) {
                ...
                // Handle success response
                alert('Data reconciled successfully!');
                window.location.href = "ONUSReconciledReport";
            },
            error: function (xhr, status, error) {
                // Hide loading spinner on error
                /*$('#loading-dialog').hide();*/
...
function getAmortizationSummary() {
    ...
    //token = $(token).val();
    $.ajax({
        url: config.ONUSReconciledReport,
